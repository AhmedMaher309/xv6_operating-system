...
main(int argc, char *argv[])
{
  ...
  10:	378080e7          	jalr	888(ra) # 384 <pipe>
  ...
  1e:	352080e7          	jalr	850(ra) # 36c <fork>
    // error in forking
	if(pid == -1){
  22:	57fd                	li	a5,-1
  24:	06f50263          	beq	a0,a5,88 <main+0x88>
  ...
  38:	358080e7          	jalr	856(ra) # 38c <read>
		//close(p[0]);
		fprintf(1, "%d: received ping\n", getpid());
  3c:	00000097          	auipc	ra,0x0
  40:	3b8080e7          	jalr	952(ra) # 3f4 <getpid>
  44:	862a                	mv	a2,a0
  46:	00001597          	auipc	a1,0x1
  4a:	87a58593          	addi	a1,a1,-1926 # 8c0 <malloc+0x11a>
  4e:	4505                	li	a0,1
  50:	00000097          	auipc	ra,0x0
  54:	670080e7          	jalr	1648(ra) # 6c0 <fprintf>
		write(p[1], &byte, 1);
  58:	4605                	li	a2,1
  5a:	fe740593          	addi	a1,s0,-25
  5e:	fec42503          	lw	a0,-20(s0)
  62:	00000097          	auipc	ra,0x0
  66:	332080e7          	jalr	818(ra) # 394 <write>
        wait(0);
		read(p[0], &byte, 1);
		//close(p[0]);
  ...
  70:	308080e7          	jalr	776(ra) # 374 <exit>
		fprintf(2, "Error: pipe(fd) error.\n");
  74:	00001597          	auipc	a1,0x1
  78:	81c58593          	addi	a1,a1,-2020 # 890 <malloc+0xea>
  7c:	4509                	li	a0,2
  7e:	00000097          	auipc	ra,0x0
  82:	642080e7          	jalr	1602(ra) # 6c0 <fprintf>
  86:	bf51                	j	1a <main+0x1a>
		fprintf(2, "Error in forking\n");
  88:	00001597          	auipc	a1,0x1
  8c:	82058593          	addi	a1,a1,-2016 # 8a8 <malloc+0x102>
  90:	4509                	li	a0,2
  92:	00000097          	auipc	ra,0x0
  96:	62e080e7          	jalr	1582(ra) # 6c0 <fprintf>
		exit(1);
  9a:	4505                	li	a0,1
  9c:	00000097          	auipc	ra,0x0
  a0:	2d8080e7          	jalr	728(ra) # 374 <exit>
		write(p[1], &byte, 1);
  a4:	4605                	li	a2,1
  a6:	fe740593          	addi	a1,s0,-25
  aa:	fec42503          	lw	a0,-20(s0)
  ae:	00000097          	auipc	ra,0x0
  b2:	2e6080e7          	jalr	742(ra) # 394 <write>
        wait(0);
  b6:	4501                	li	a0,0
  b8:	00000097          	auipc	ra,0x0
  bc:	2c4080e7          	jalr	708(ra) # 37c <wait>
		read(p[0], &byte, 1);
  c0:	4605                	li	a2,1
  c2:	fe740593          	addi	a1,s0,-25
  c6:	fe842503          	lw	a0,-24(s0)
  ca:	00000097          	auipc	ra,0x0
  ce:	2c2080e7          	jalr	706(ra) # 38c <read>
		printf("%d: received pong\n", getpid() );;
  d2:	00000097          	auipc	ra,0x0
  d6:	322080e7          	jalr	802(ra) # 3f4 <getpid>
  da:	85aa                	mv	a1,a0
  dc:	00000517          	auipc	a0,0x0
  e0:	7fc50513          	addi	a0,a0,2044 # 8d8 <malloc+0x132>
  e4:	00000097          	auipc	ra,0x0
  e8:	60a080e7          	jalr	1546(ra) # 6ee <printf>
  ec:	bfbd                	j	6a <main+0x6a>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 45c:	4f850513          	addi	a0,a0,1272 # 950 <digits>
 460:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 51c:	3e0c8c93          	addi	s9,s9,992 # 8f8 <malloc+0x152>
 ...
 650:	2a498993          	addi	s3,s3,676 # 8f0 <malloc+0x14a>
        while(*s != 0){
 654:	85ee                	mv	a1,s11
